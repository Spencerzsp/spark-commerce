    ...
    public void updateBatch(List<AdUserClickCount> adUserClickCounts) {
        ...
        for (AdUserClickCount insertAdUserClickCount : insertAdUserClickCounts) {
            insertParam = new Object[]{
                insertAdUserClickCount.getDate(),
                insertAdUserClickCount.getUserid(),
                insertAdUserClickCount.getAdid(),
                insertAdUserClickCount.getClickCount()
            };
        ...
        for (AdUserClickCount updateAdUserClickCount : updateAdUserClickCounts) {
            updateParam = new Object[]{
              updateAdUserClickCount.getClickCount(),
                    updateAdUserClickCount.getDate(),
                    updateAdUserClickCount.getAdid(),
                    updateAdUserClickCount.getUserid()
            };
